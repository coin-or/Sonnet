...
namespace SonnetTest
{
    ...
    public class Sonnet_QuadraticTests
    {
        ...
        public void SonnetTestQuad3()
        {
            ...
            // MIQP doesnt work using Clp, only Cbc. But not supported in this version.
            ...
            // Solving MIQP is not supported in this version.
            // Reading MIQP from MPS is NOT supported in this version.
        }
